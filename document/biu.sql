...
INSERT INTO `sys_user` VALUES ('1108262464853676033', 'shuokai', '烁凯', 'zoHf5PsQzTvfb6QmplYrJgT0BwGKXoBwaxSge9r7k94=', 'vqAEtclrrU6xj4mDVpnPXg==', null, '2019-03-20 15:02:16', '2019-04-15 16:17:03');
...
INSERT INTO `sys_user_role` VALUES ('1108262464853676033', '1002748319131680769');
INSERT INTO `sys_user_role` VALUES ('986177923098808322', '999999888888777777');

-- ----------------------------
-- Procedure structure for sys
-- ----------------------------
DROP PROCEDURE IF EXISTS `sys`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sys`()
BEGIN
	SELECT * from sys_user where uname = 'zhangfei';
